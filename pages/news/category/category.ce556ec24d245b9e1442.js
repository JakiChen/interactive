(window.webpackJsonp = window.webpackJsonp || []).push([
    [14], {
        343: function (t, e, n) {
            ...
            (0, n(13).default)("1c023f33", content, !0, {
                sourceMap: !1
            })
        },
        344: function (t, e) {
            t.exports = function (t) {
                t.options.__i18n = t.options.__i18n || [], t.options.__i18n.push('{"ja":{"title":"Category"},"en":{"title":"Category"}}'), delete t.options._Ctor
            }
        },
        393: function (t, e, n) {
            "use strict";
            ...
            var d, f = {
                    asyncData: (d = Object(o.a)(regeneratorRuntime.mark((function t(e) {
                        ...
                        return regeneratorRuntime.wrap((function (t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return n = e.app, r = e.store, o = e.params, e.payload, t.next = 3, n.$api.getIdNameFromSlug({
                                        type: "category",
                                        slug: o.category
                                    });
                                case 3:
                                    return l = t.sent, t.next = 6, n.$api.getPostsPerPage({
                                        lang: r.$i18n.locale,
                                        page: 1,
                                        per_page: 10,
                                        categories: l.id
                    ...
                    mounted: function () {
                        ...
                        this.$nextTick((function () {
                            $g.fn.utility.updateViewType(), $g.fn.utility.staggerElement(".subpage-hero-sub-ttl"), $g.fn.utility.staggerElement(".subpage-hero-ttl"), t.$eventHub.$emit("helixSetState", !0), detect.webp && t.replaceWebP(), observer.init($g.configs.observerSettings), t.loaded && t.init("default"), t.$eventHub.$on("onScroll", t.onScroll), t.$eventHub.$on("onResize", t.onResize), t.$eventHub.$on("onWindowOut", t.onWindowOut)
                        }))
                    },
                    beforeDestroy: function () {
                        observer.destroy(), this.$eventHub.$off("onScroll", this.onScroll), this.$eventHub.$off("onResize", this.onResize), this.$eventHub.$off("onWindowOut", this.onWindowOut)
                    },
                    methods: {
                        init: function (t) {
                            switch (t) {
                                        ...
                                        e.$store.app.$api.getMorePosts({
                                            ...
                                            callback: function (n) {
                                                n.forEach((function (r, o) {
                                                    e.posts.push(r), n.length === o + 1 && (requestTimeout((function () {
                ...
                component = Object(h.a)(f, (function () {
                    var t = this,
                        ...
                        n = t._self._c || e;
                    return n("div", {
                        class: "p-" + t.className + " | p-category"
                    }, [n("section", {
                ...
                }], !1, null, "647ee760", null);
            "function" == typeof m.default && Object(m.default)(component);
